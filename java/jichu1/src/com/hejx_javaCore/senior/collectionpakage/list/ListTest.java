package com.hejx_javaCore.senior.collectionpakage.list;

import com.hejx_javaCore.senior.collectionpakage.Person;
 ...
 * 总结：常用方法
 * 增：add(Object ele)
 * 删：remove(Object ele)/remove(int index)
...
public class ListTest {
    ...
    public void test2(){
        ...
        //Object set(int index, Object ele):设置指定index位置的元素为ele
        System.out.println(list.set(3, 789));
        System.out.println(list);
    ...
    public void test1(){
        ...
        list.add(new Person("Tome",12));
        list.add(456);
        //void add()void add(int index, Object ele):在index位置插入ele元素
        list.add(1,"BB");
        System.out.println(list);

        //boolean addAll(int index, Collection eles):从index位置开始将eles中的所有元素添加进来
        List<Integer> integers = Arrays.asList(1, 2, 3);
        //list.addAll(4,integers);
